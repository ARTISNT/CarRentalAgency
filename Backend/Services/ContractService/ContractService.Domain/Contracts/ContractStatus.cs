...
public class ContractStatus : Enumeration
{
    ...
    public static readonly ContractStatus Cancelled = new ContractStatus(3, "Cancelled");
    public static readonly ContractStatus AwaitingSignature = new ContractStatus(4, "AwaitingSignature");
